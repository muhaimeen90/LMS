      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Quiz Results</h1>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm dark:bg-gray-800 overflow-hidden">
            <div className="p-6">
              <div className="text-center mb-6">
                <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-blue-50 dark:bg-blue-900/30 mb-4">
                  <span className="text-2xl font-bold text-blue-700 dark:text-blue-300">
                    {quizResults.score}/{quiz.questions.length}
                  </span>
                </div>
                ...
                <div className="mt-2 text-sm text-gray-500 dark:text-gray-400">
                  Time taken: {formatTimeText(quizResults.timeTaken)}
                </div>
                ...
                {quizResults.passed ? (
                  ...
                  <div className="mt-3 p-3 bg-yellow-50 border border-yellow-200 rounded-lg text-sm text-yellow-800 dark:bg-yellow-900/30 dark:border-yellow-800 dark:text-yellow-300">
                    You didn't meet the passing score. Would you like to try again?
                  </div>
                )}
              </div>
              ...
              <div className="flex justify-center space-x-4">
                ...
                <Link
                  href="/quizzes"
                  className="px-4 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600"
                >
